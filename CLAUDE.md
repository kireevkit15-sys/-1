...
- «Руководитель», «Lead», «лид» → задачи секции "Руководитель (Lead)"
- «Разработчик 1», «Frontend», «фронт» → задачи секции "Разработчи�� 1 (Frontend)"
- «Разработчик 2», «Backend», «бэк» → задачи секции "��азработчик 2 (Backend)"

**Если роль не указана** — спросить: «Какая у тебя роль в команде? Lead / Frontend / Backend?»
