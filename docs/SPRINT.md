...
При входе в проект скажи свою роль:
- **«Я руководитель»** или **«Lead»** — получишь задачи Lead
- **«Я разработчик 1»** или **«Frontend»** — получишь задачи Frontend
- **«Я разработчик 2»** или **«Backend»** — получишь задачи Backend
